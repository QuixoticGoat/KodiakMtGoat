...
# Load the data:
load("./data/derived/df.testtrain.Rdata")
...
source("./code/AIC.mclogit.R")  # For the AIC.mclogit function
...
save(mod, file = "./output/models/ModG.s.cond.Rdata", compress = "gzip")
# rm(mod, Covariate)
...
save(mod, file = "./output/models/ModT.s.cond.Rdata", compress = "gzip")
rm(mod, Covariate)
...
save(mod, file = "./output/models/ModH.s.cond.Rdata", compress = "gzip")
rm(mod, Covariate)
...
save(best, file = "./data/derived/mod_summer_final.Rdata", compress = "gzip")

load(file = "./output/models/mod_summer_final.Rdata")
...
# Load the data:
load("./data/derived/df.cond.Rdata")
...
save(mod, file = "./output/models/ModG.w.cond.Rdata", compress = "gzip")
rm(mod)
...
save(mod, file = "./output/models/ModT.w.cond.Rdata", compress = "gzip")
rm(mod, Covariate)
...
save(mod, file = "./output/models/ModH.w.cond.Rdata", compress = "gzip")
rm(mod, Covariate)
...
save(best, file = "./output/models/mod_winter_final.Rdata", compress = "gzip")
...
load(file="./data/derived/df.ua.RData")
