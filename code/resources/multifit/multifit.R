...
# 
# https://github.com/phuais/multifit
# Multi-scale analysis in landscape ecology
# 
# The main goal of multifit is to automate the process of multi-scale analysis for 
# landscape ecologists. In this way, multifit allows the user to run many 
# statistical models at the same time (i.e. one for each studied spatial scale), 
# visualize the output in a simple way, allowing the user to select the best model 
# according to a specified criterion. A comprehensive description of the function 
# usage is detailed in the pdf manual of this repository.
